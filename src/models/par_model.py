...
class PARModel(nn.Module):
    ...
    def expand(self, task_id, g, num_train_samples):
        self.experts.append(
            Expert(self.task_input_size, self.num_layers, self.init_channel, g).to(self.device)
        )
        ...
        self.expert2genotype.append(len(self.genotypes) - 1)
    ...
    def add_mean_cov(self, mean, cov):
