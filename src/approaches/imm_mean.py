...
class Appr(object):
    ...
    def __init__(self,model,epochs=100,batch=64,lr=0.05,lr_min=1e-4,lr_factor=3,lr_patience=5,
        ...
        self.lr=args.lr
        self.c_l2 = args.c_l2 # Grid search = [0.01,0.005,0.001,0.0005,0.0001,0.00005,0.000001]; best was 0.0001
        self.lamb=args.lamb
    ...
    def learn(self, t, train_data, valid_data, device='cuda'):
        ...
        if t>0:
            ...
            for name, param in self.model.named_parameters():
                # compute the average weights of all task models up to now
